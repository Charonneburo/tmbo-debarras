...
const KB = [
  ...
  { k:['gravat','gravas'],
    r:"⚠️ Les gravats, c'est pas notre rayon ! 😅<br>Pour les enlever, deux options selon la quantité :<br>• <strong>Petite quantité</strong> → déchetterie municipale (gratuit avec justificatif de domicile)<br>• <strong>Grande quantité</strong> → contactez votre mairie, elle peut orienter vers un prestataire agréé ou commander une benne.<br>En revanche, si vous avez du <em>mobilier ou des déchets non-chantier</em> à côté, on s'en occupe volontiers ! 💪" },
  { k:['amiante'],
    r:"🚫 L'amiante nécessite un traitement très spécifique — ce n'est pas dans nos cordes.<br>Il faut faire appel à une <strong>entreprise certifiée amiante</strong> (liste sur le site de l'INRS ou de votre DREAL régionale). Votre mairie peut aussi vous orienter. Ne prenez aucun risque !" },
  { k:['toxique','chimique','huile','pneu'],
    r:"⚠️ Les déchets dangereux (produits chimiques, huiles, pneus…) relèvent de filières spécialisées.<br>• <strong>Déchetterie agréée</strong> : cherchez sur <em>sinoe.org</em> ou via votre mairie.<br>• Huiles moteur usagées : certains garages les reprennent gratuitement.<br>Le reste du débarras autour, on s'en charge avec plaisir 😉" },
  { k:['beton','chantier'],
    r:"🧱 Les déchets de chantier (béton, plâtre, carrelage…) ne font pas partie de nos prestations.<br>Votre meilleure option : une <strong>déchetterie professionnelle</strong> ou une benne via votre mairie. L'entreprise de travaux a aussi l'obligation légale de gérer ses propres déchets 👷<br>Pour le reste du débarras hors chantier, on est là !" },
  { k:['dechet'],
    r:"La réponse dépend du type de déchet ! Pour les déchets classiques (mobilier, cartons, électronique), TMBO est là. Pour les déchets de chantier ou dangereux, il faut une filière spécialisée. Précisez ce que vous avez et je vous oriente 😊" },
